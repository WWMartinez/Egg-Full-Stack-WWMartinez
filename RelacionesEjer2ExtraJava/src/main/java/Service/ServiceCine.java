...
public class ServiceCine {
            ...
            for (int j = 0; j < 6; j++) {
                switch (j) {
                    ...
                    case 5:
                        ...
                        break;
                    default:
                        System.out.println("Salió del rango disponible");
                }
                sala[i][j] = asiento;
    ...
    public void ubicarEspectador(Cine cine) {
        ...
        if (espectador.getDinero() >= cine.getPrecio() && espectador.getEdad() >= cine.getPelicula().getEdadMin() && cantEspectadores < 48) {
            ...
            System.out.println("El espectador no dispones de suficiente dinero o es menor de edad\n");
        }
    }
    ...
    public void generarEspecAletorios(Cine cine) {
        for (int i = 0; i < 20; i++) {
            int fila;
            int columna;
            do {
